...
## Learning
---
- [Leveraging DBT as a Data Modeling tool](https://medium.com/analytics-and-data/leveraging-dbt-as-a-data-modeling-tool-b3caf78f4a3a) - Reflection on one-year usage of dbt for modelling, documentation, testing and deployment
...
- [dbt Fundamentals](https://courses.getdbt.com/collections) - Official free course offered by dbt. Excellent for learning the basics od dbt Cloud.
...
- [dbt_utils](https://hub.getdbt.com/dbt-labs/dbt_utils/latest/) - General macros libary. A must have.
